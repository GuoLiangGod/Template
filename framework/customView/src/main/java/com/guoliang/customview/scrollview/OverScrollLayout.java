...
public class OverScrollLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private ValueAnimator getAnimator(int firstValue, int secondValue, AnimatorUpdateListener updateListener, Animator.AnimatorListener animatorListener, Interpolator interpolator) {
     ...
     */
    private final AnimatorUpdateListener headerAnimationUpdate = new AnimatorUpdateListener() {
    ...
    private final AnimatorUpdateListener footerAnimationUpdate = new AnimatorUpdateListener() {
        public void onAnimationUpdate(ValueAnimator animation) {
            if (onScrollerScrollChangeListener != null)
                onScrollerScrollChangeListener.onScrollChange((Integer) animation.getAnimatedValue());
            moveChildren((Integer) animation.getAnimatedValue());
    ...
    private final AnimatorUpdateListener overScrollAnimatorUpdate = new AnimatorUpdateListener() {
        public void onAnimationUpdate(ValueAnimator animation) {
    ...
    public void loadMoreComplete(boolean noMore) {
        ...
        if (getFooterView() != null)
            ((OnPullListener) getFooterView()).loadMoreComplete(noMore);
    }
