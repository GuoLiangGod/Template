            ...
            switch (headerShowGravity) {
                ...
                case PLACEHOLDER_CENTER:
                    prl.headerView.setTranslationY(moveDistance <= prl.refreshTriggerDistance ? 0
                            : (moveDistance - prl.refreshTriggerDistance) / 2f);
                    break;
                case PLACEHOLDER_FOLLOW:
                    ...
                    break;
                case CENTER:
                    prl.headerView.setTranslationY(moveDistance / 2f);
                    break;
                case CENTER_FOLLOW:
                    prl.headerView.setTranslationY(moveDistance <= prl.refreshTriggerDistance
                            ? moveDistance / 2f : moveDistance - prl.refreshTriggerDistance / 2f);
                    break;
                default:
                    break;
            }
            ...
            switch (footerShowGravity) {
                ...
                case FOLLOW_CENTER:
                    prl.footerView.setTranslationY(moveDistance <= -prl.loadTriggerDistance ? -prl.loadTriggerDistance
                            + (prl.loadTriggerDistance + moveDistance) / 2f : moveDistance);
                    break;
                case PLACEHOLDER_CENTER:
                    prl.footerView.setTranslationY(moveDistance <= -prl.loadTriggerDistance
                            ? (moveDistance + prl.loadTriggerDistance) / 2f : 0);
                    break;
                case PLACEHOLDER_FOLLOW:
                    prl.footerView.setTranslationY(moveDistance <= -prl.loadTriggerDistance
                    ...
                    break;
                case CENTER:
                    prl.footerView.setTranslationY(moveDistance / 2f);
                    break;
                case CENTER_FOLLOW:
                    prl.footerView.setTranslationY(moveDistance <= -prl.loadTriggerDistance
                            ? moveDistance + prl.loadTriggerDistance / 2f : moveDistance / 2f);
                    break;
                default:
                    break;
            }
